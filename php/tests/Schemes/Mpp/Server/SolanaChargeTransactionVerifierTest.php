...
use PayKit\Schemes\Mpp\Server\SolanaChargeTransactionVerifier;
...
final class SolanaChargeTransactionVerifierTest extends TestCase
{
    ...
    private function verify(ChargeRequest $request, string $transaction): \PayKit\Schemes\Mpp\Server\VerificationResult
    {
        $server = new ChargeServer(secretKey: 'secret', realm: 'api');
