...
final class SolanaChargeHandler
{
     ...
     *        transactions by signature. Defaults to the same instance as
     *        $verifier when that also implements the interface.
    ...
    /**
     * Settle pull-mode transaction credentials or verify push-mode signature
     * credentials. In pull mode this broadcasts the client-built transaction;
     * in push mode this fetches the already-broadcast transaction back from
     * the RPC and runs the same structural verifier against it.
     */
    ...
    /**
     * Fetch a confirmed push-mode transaction by signature and return the
     * base64-encoded wire bytes for re-verification.
     */
