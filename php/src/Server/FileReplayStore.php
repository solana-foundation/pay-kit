 ...
 *
 * Useful for examples, local development, and single-host PHP-FPM setups. For
 * multi-host production deployments, provide a ReplayStore backed by a shared
 * database, Redis, or another atomic cross-worker store.
 */
