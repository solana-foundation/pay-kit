...
> {
    return combineCodec(getRequestCloseInstructionDataEncoder(), getRequestCloseInstructionDataDecoder());
}

export type RequestCloseInput<TAccountPayer extends string = string, TAccountChannel extends string = string> = {
...
>(
    ...
    return Object.freeze({
        accounts: [getAccountMeta('payer', accounts.payer), getAccountMeta('channel', accounts.channel)],
...
export function parseRequestCloseInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
