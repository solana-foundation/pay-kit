...
import { getOpenArgsDecoder, getOpenArgsEncoder, type OpenArgs, type OpenArgsArgs } from '../types/index.js';
...
export type OpenInstruction<
    ...
    TAccountSelfProgram extends string | AccountMeta<string> = 'CHNLxYvVA28MJP9PrFuDXccuoGXAx7jBacfLEkahyGsX',
...
export function parseOpenInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
