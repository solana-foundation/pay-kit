...
and the Ruby adapter at tests/harness/ruby-server/server.rb. The harness
...
# Ensure the local Python SDK is importable when run from tests/harness.
...
# ``tests/harness`` (parents[0]=python-server, parents[1]=interop,
