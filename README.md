...
| Interop | ![Interop](https://img.shields.io/badge/interop-TypeScript_harness-brightgreen) | `cd tests/harness && pnpm test` |

See [`tests/harness/README.md`](tests/harness/README.md) for the process adapter contract used by the Surfpool-backed client/server matrix.
