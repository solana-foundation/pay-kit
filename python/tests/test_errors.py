...
class TestCanonicalCodes:
    ...
    def test_canonical_codes_set(self):
        from pay_kit.protocols.mpp.core.errors import CANONICAL_CODES
    ...
    def test_canonical_code_returns_canonical_unchanged(self):
        from pay_kit.protocols.mpp.core.errors import canonical_code
...
class TestPaymentRequiredResponseBuilder:
    def test_emits_canonical_code(self):
        from pay_kit.protocols.mpp.core.errors import payment_required_response
