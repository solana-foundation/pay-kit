...
Hits every branch in :mod:`pay_kit.protocols.mpp.core.rpc` so the JSON-RPC wrapper meets
...
from pay_kit.protocols.mpp.core.rpc import SolanaRpc, _RpcError, _RpcResponse
...
async def test_confirm_transaction_timeout():
    ...
    import pay_kit.protocols.mpp.core.rpc as rpc_mod
