"""Exception hierarchy for solana_pay_kit.
...
underlying ``solana_pay_kit.protocols.mpp`` ``PaymentError.code`` to these at the boundary via
``solana_pay_kit._paycore.errors.canonical_code``.
"""
...
class PayKitError(Exception):
    """Root of every solana_pay_kit exception; catch this for a generic handler."""
