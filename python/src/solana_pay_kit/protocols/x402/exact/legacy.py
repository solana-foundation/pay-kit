...
#: by the solana_pay_kit server but accepted on the gate so a testnet legacy credential
...
#: constants.rs:19). solana_pay_kit follows the rust spine: a legacy challenge MAY ship
