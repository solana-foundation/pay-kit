...
The implementation moved to :mod:`pay_kit._paycore.paymentchannels` so the MPP
...
``pay_kit.protocols.mpp._paymentchannels`` for existing callers and tests; new
code should import from :mod:`pay_kit._paycore.paymentchannels` directly.
"""
