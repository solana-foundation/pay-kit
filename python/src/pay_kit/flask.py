...
def require_usage(
    ...
    *,
    ...
    :class:`~pay_kit.usage.Charge` meter (read it with :func:`charge` or
    :func:`pay_kit.usage.charge_from`); after the view it settles the metered
...
def charge() -> Charge | None:
    """The usage :class:`~pay_kit.usage.Charge` meter for the request, or ``None``."""
...
def _run(coro: Coroutine[Any, Any, _T]) -> _T:
    """Drive a pay_kit async coroutine from Flask's synchronous view context.
