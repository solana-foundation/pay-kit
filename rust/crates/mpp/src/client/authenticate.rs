...
use crate::protocol::core::{format_authorization, PaymentChallenge, PaymentCredential};
...
mod tests {
    use super::*;
    use crate::program::subscriptions::{find_subscription_pda, SUBSCRIPTIONS_PROGRAM_ID};
    use crate::server::authenticate::{AuthenticateConfig, AuthenticateServer};
    ...
    async fn rejects_non_authenticate_intent() {
        ...
        let challenge = crate::server::Mpp::new(crate::server::Config {
