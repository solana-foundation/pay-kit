...
```toml
# Gate routes with the unified dual-protocol axum gate (this README):
...
The cross-language harness lives in [`../../../harness`](../../../harness). The
Rust SDK ships `harness_server` / `harness_client` binaries used by the
