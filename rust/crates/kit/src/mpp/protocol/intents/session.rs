...
impl OpenPayload {
    ...
    pub fn deposit_amount(&self) -> crate::mpp::error::Result<u64> {
        ...
        raw.parse()
            .map_err(|_| crate::mpp::error::Error::Other(format!("invalid deposit amount: {raw}")))
    }
}
...
impl VoucherData {
    ...
    pub fn message_bytes(&self) -> crate::mpp::error::Result<Vec<u8>> {
        ...
        let cumulative = self.cumulative.parse().map_err(|_| {
