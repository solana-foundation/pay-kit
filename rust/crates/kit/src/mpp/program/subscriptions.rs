...
use crate::generated::subscriptions::generated::instructions::{
...
use crate::generated::subscriptions::generated::types::{
...
mod tests {
    ...
    fn build_create_plan_ix_emits_five_account_metas_in_program_order() {
        ...
        let token_program =
            Pubkey::from_str(crate::mpp::protocol::solana::programs::TOKEN_PROGRAM).unwrap();
    ...
    fn build_transfer_subscription_ix_marks_only_caller_as_signer() {
        ...
        let accounts = TransferSubscriptionAccounts {
            ...
            token_program: Pubkey::from_str(crate::mpp::protocol::solana::programs::TOKEN_PROGRAM)
                .unwrap(),
            event_authority: find_event_authority_pda(&program).0,
        };
        let data = TransferData {
    ...
    fn generated_cancel_subscription_idl_still_diverges_from_program() {
        use crate::generated::subscriptions::generated::instructions::CancelSubscription as Gen;
        let gen = Gen {
