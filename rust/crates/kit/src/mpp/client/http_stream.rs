...
mod tests {
    use super::*;
    use crate::mpp::protocol::intents::session::CommitStatus;
    use crate::mpp::solana_keychain::MemorySigner;
    ...
    fn signer() -> Box<dyn crate::mpp::solana_keychain::SolanaSigner> {
    ...
    fn directive(session_id: &str) -> MeteringDirective {
        MeteringDirective {
            ...
            sequence: 1,
            expires_at: crate::mpp::client::session::DEFAULT_VOUCHER_EXPIRES_AT,
            commit_url: None,
            proof: None,
        }
    }
