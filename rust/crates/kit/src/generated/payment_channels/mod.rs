...
//! builders live in `crate::mpp::program::payment_channels` so the codegen
//! output stays a pure pass-through and `just payment-channels-generate-rs` can
//! wipe `generated/` without touching anything authored.
