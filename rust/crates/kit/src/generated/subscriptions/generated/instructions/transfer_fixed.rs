...
use crate::generated::subscriptions::generated::types::TransferData;
...
impl TransferFixed {
    pub fn instruction(
        &self,
        args: TransferFixedInstructionArgs,
...
pub struct TransferFixedInstructionData {
    discriminator: u8,
}

impl TransferFixedInstructionData {
    pub fn new() -> Self {
...
impl Default for TransferFixedInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct TransferFixedInstructionArgs {
    pub transfer_data: TransferData,
}

impl TransferFixedInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `TransferFixed`.
///
/// ### Accounts:
///
...
impl TransferFixedBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = TransferFixedInstructionArgs {
            transfer_data: self
                .transfer_data
                .clone()
                .expect("transfer_data is not set"),
        };
...
/// `transfer_fixed` CPI accounts.
pub struct TransferFixedCpiAccounts<'a, 'b> {
    /// The fixed delegation PDA to transfer from
...
/// `transfer_fixed` CPI instruction.
pub struct TransferFixedCpi<'a, 'b> {
    ...
    pub __args: TransferFixedInstructionArgs,
}

impl<'a, 'b> TransferFixedCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: TransferFixedCpiAccounts<'a, 'b>,
        args: TransferFixedInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `TransferFixed` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` delegation_pda
...
///   8. `[]` self_program
#[derive(Clone, Debug)]
pub struct TransferFixedCpiBuilder<'a, 'b> {
    instruction: Box<TransferFixedCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> TransferFixedCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(TransferFixedCpiBuilderInstruction {
            __program: program,
            delegation_pda: None,
    ...
    pub fn delegation_pda(
        &mut self,
        delegation_pda: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    /// The delegator's ATA to transfer from
    #[inline(always)]
    pub fn delegator_ata(
        &mut self,
        delegator_ata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn receiver_ata(
        &mut self,
        receiver_ata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = TransferFixedCpi {
            __program: self.instruction.__program,

            delegation_pda: self
                .instruction
                .delegation_pda
                .expect("delegation_pda is not set"),
            ...
            delegator_ata: self
                .instruction
                .delegator_ata
                .expect("delegator_ata is not set"),

            receiver_ata: self
                .instruction
                .receiver_ata
                .expect("receiver_ata is not set"),
...
#[derive(Clone, Debug)]
struct TransferFixedCpiBuilderInstruction<'a, 'b> {
