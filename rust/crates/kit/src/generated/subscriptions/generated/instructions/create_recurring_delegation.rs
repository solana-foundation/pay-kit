...
use crate::generated::subscriptions::generated::types::CreateRecurringDelegationData;
use borsh::BorshDeserialize;
use borsh::BorshSerialize;

pub const CREATE_RECURRING_DELEGATION_DISCRIMINATOR: u8 = 2;

/// Accounts.
#[derive(Debug)]
pub struct CreateRecurringDelegation {
...
pub struct CreateRecurringDelegationInstructionData {
    discriminator: u8,
}

impl CreateRecurringDelegationInstructionData {
    pub fn new() -> Self {
...
impl Default for CreateRecurringDelegationInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct CreateRecurringDelegationInstructionArgs {
    pub recurring_delegation: CreateRecurringDelegationData,
}

impl CreateRecurringDelegationInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `CreateRecurringDelegation`.
///
/// ### Accounts:
///
...
impl CreateRecurringDelegationBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The user creating the delegation
    ...
    pub fn recurring_delegation(
        ...
        self.recurring_delegation = Some(recurring_delegation);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = CreateRecurringDelegation {
        ...
        let args = CreateRecurringDelegationInstructionArgs {
            recurring_delegation: self
                ...
                .clone()
                .expect("recurring_delegation is not set"),
        };
...
/// `create_recurring_delegation` CPI accounts.
pub struct CreateRecurringDelegationCpiAccounts<'a, 'b> {
    /// The user creating the delegation
...
pub struct CreateRecurringDelegationCpi<'a, 'b> {
...
impl<'a, 'b> CreateRecurringDelegationCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: CreateRecurringDelegationCpiAccounts<'a, 'b>,
        args: CreateRecurringDelegationInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CreateRecurringDelegation` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` delegator
...
impl<'a, 'b> CreateRecurringDelegationCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreateRecurringDelegationCpiBuilderInstruction {
            __program: program,
            delegator: None,
    ...
    pub fn recurring_delegation(
        ...
        self.instruction.recurring_delegation = Some(recurring_delegation);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = CreateRecurringDelegationCpi {
...
#[derive(Clone, Debug)]
struct CreateRecurringDelegationCpiBuilderInstruction<'a, 'b> {
