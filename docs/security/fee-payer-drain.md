...
| -------- | ------------------------------------------------------------ |
| Rust     | [`rust/crates/mpp/src/server/charge.rs`](../../rust/crates/mpp/src/server/charge.rs): `validate_instruction_allowlist` (L1284), `validate_parsed_instruction_allowlist` (L1860), `expected_fee_payer` (L1227) |
