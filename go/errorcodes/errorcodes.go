...
func Canonical(code mpp.ErrorCode) string {
	switch code {
	case mpp.ErrCodeAmountMismatch,
		mpp.ErrCodeRecipientMismatch,
		mpp.ErrCodeSplitsExceed,
		mpp.ErrCodeTooManySplits:
		return ChargeRequestMismatch
	case mpp.ErrCodeChallengeRouteMismatch,
		mpp.ErrCodeMintMismatch,
		mpp.ErrCodeInvalidMethod:
		return ChallengeRouteMismatch
	case mpp.ErrCodeChallengeMismatch:
		return ChallengeVerificationFailed
	case mpp.ErrCodeChallengeExpired:
		return ChallengeExpired
	case mpp.ErrCodeWrongNetwork:
		return WrongNetwork
	case mpp.ErrCodeSignatureConsumed:
		return SignatureConsumed
	case mpp.ErrCodeRPC,
		mpp.ErrCodeTransactionFailed,
		mpp.ErrCodeTransactionNotFound,
		mpp.ErrCodeNoTransfer,
		mpp.ErrCodeSimulationFailed,
		mpp.ErrCodeMissingTransaction,
