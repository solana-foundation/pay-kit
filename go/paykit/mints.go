...
func ResolveMint(coin Stablecoin, network Network) string {
	return protocol.ResolveMint(string(coin), network.MintsLabel())
}
...
func TokenProgramFor(coin Stablecoin, network Network) string {
	return protocol.DefaultTokenProgramForCurrency(string(coin), network.MintsLabel())
}
