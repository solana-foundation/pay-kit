...
module Mpp
  ...
  #
  # `canonical_code` maps a Ruby `Mpp::Error` message or a legacy code to the
  ...
  module ErrorCodes
    ...
    # Substring patterns that classify a Ruby `Mpp::Error#message` into a
    # canonical code when no explicit code was set at raise time. Ordered;
    # first match wins.
    MESSAGE_PATTERNS = [
      ...
      # TS/Rust/Lua canonical classifiers (tests/harness/src/canonical-codes.ts
