...
module Mpp
  module Core
    # RFC 3339 date-time parser used by Challenge#expired?.
    #
    # Extracted from challenge.rb per PR #102 review (inline comment
    # 3298110199) so RFC parsing logic lives in a dedicated file. Lua
    # already keeps the parser in lua/mpp/expires.lua; PHP moves the
    # regex to Rfc3339Parser in the same review round.
    #
