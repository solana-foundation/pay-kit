...
module Mpp
  # Sinatra integration for MPP. Loaded behind `require "mpp/sinatra"` so
  # apps that don't use Sinatra don't pay the dependency cost at require time.
  #
  #   require "mpp/sinatra"
  #
  #   class App < Sinatra::Base
  #     helpers Mpp::Sinatra::Helpers
  #     set :mpp_server, Mpp.create(method: ..., secret_key: ..., realm: ...)
  #
  #     get "/paid" do
