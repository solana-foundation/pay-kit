...
module PayKit::Protocols::Mpp
  module Server
    ...
    #
    #   use PayKit::Protocols::Mpp::Server::Middleware, handler: PayKit::Protocols::Mpp.create(...)
    #
    #   get "/paid" do
    ...
    # expensive routes, prefer the Sinatra helper PayKit::Protocols::Mpp::Sinatra::Helpers, which
    # halts early.
    class Middleware
