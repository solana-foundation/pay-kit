    ...
    module Core
      ...
      class ChallengeStore
        ...
        def create_challenge_header(request, expires: nil, description: nil)
          ::PayKit::Protocols::Mpp::Protocol::Core::Headers.format_www_authenticate(create_challenge(request, expires: expires, description: description))
        end
        ...
        def payment_required_response(request, reason: nil, code: nil)
          ...
          ::PayKit::Protocols::Mpp::Challenge.new(www_authenticate: header, body: body, reason: reason)
        end
        ...
        def create_receipt_header(challenge:, reference:, external_id: nil)
          ...
          ::PayKit::Protocols::Mpp::Protocol::Core::Headers.format_receipt(receipt)
        end
