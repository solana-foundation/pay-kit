...
module PayKit::Protocols::Mpp
  ...
  # as HTTP 402 to the client. Use PayKit::Protocols::Mpp::Server::Decorator.make_challenge_response
  ...
  class Challenge
    ...
    def headers
      {::PayKit::Protocols::Mpp::Protocol::Core::Headers::WWW_AUTHENTICATE => www_authenticate}
    end
  end
end
