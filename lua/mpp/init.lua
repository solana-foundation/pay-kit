-- MPP protocol-layer aggregator. Applications use the
-- `resty.pay_kit` umbrella; this entry-point is the protocol surface
-- that umbrella sits on (challenge build, header parse, signer,
-- charge_handler, store).
