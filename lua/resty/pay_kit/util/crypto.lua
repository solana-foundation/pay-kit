...
The Ed25519 surface lives in `resty.pay_kit.util.ed25519`; this
module re-exports it under the design-named path so a single
`require('resty.pay_kit.util.crypto')` brings every crypto primitive
...
M.ed25519 = require('resty.pay_kit.util.ed25519')
