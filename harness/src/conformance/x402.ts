...
// Any server-managed signer in that tail could authorize the transfer. The
// source itself must also not be a managed key or a managed key's ATA, derived
// with the transfer's real Token or Token-2022 program.
